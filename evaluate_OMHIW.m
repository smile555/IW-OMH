function [eva,train_time_round] = evaluate_OMHIW(XTrain,LTrain,XQuery,LQuery,Vector,OURparam)
    ...
    for chunki = 1:OURparam.nchunks
        ...
        % Hash code learning
        if chunki == 1
            [BB,WW,PP,UU,t] = train_OMHIW0(XTrain_new',LTrain_new',B_c,OURparam);
        else
            [BB,WW,PP,UU,t] = train_OMHIW(XTrain_new',LTrain_new',BB,PP,B_c,OURparam);
        end
